...
- Validate 18 pairwise scenarios spanning 320dp, 393dp, 673dp, and 1,000dp
...
The 18 PNGs add about 1.4 MB to the repository and no bytes to production APKs.
...
- All 18 references render and validate with zero failures.

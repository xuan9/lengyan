...
COPY = {
    "zh-Hans": {
        "01_Home":       ("宣纸长卷 · 十卷科判尽在掌中", "古朴经卷 · 触手可及的清净"),
        "05_Reading":    ("逐字精读 · 如临经卷", "黄金分割排版,昼夜柔润护眼"),
        "02_Listening":  ("耳畔梵音 · 随心而诵", "后台播放 · 锁屏续听 · 循环读诵"),
        "03_Favorites":  ("心爱经文 · 一键成画", "化经文为禅意美图 · 一键分享"),
        "04_Settings":   ("无广告 · 无追踪 · 纯粹清净", "你的阅读只属于你自己"),
    },
    "zh-Hant": {
        "01_Home":       ("宣紙長卷 · 十卷科判盡在掌中", "古樸經卷 · 觸手可及的清淨"),
        "05_Reading":    ("逐字精讀 · 如臨經卷", "黃金分割排版,晝夜柔潤護眼"),
        "02_Listening":  ("耳畔梵音 · 隨心而誦", "背景播放 · 鎖屏續聽 · 循環讀誦"),
        "03_Favorites":  ("心愛經文 · 一鍵成畫", "化經文為禪意美圖 · 一鍵分享"),
